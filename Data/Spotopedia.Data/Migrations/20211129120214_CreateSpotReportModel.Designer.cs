...
namespace Spotopedia.Data.Migrations
{
    ...
    [Migration("20211129120214_CreateSpotReportModel")]
    partial class CreateSpotReportModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.ChallengeImage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.SpotReport", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.ChallengeEntryImage", b =>
                {
                    ...
                    b.HasOne("Spotopedia.Data.Models.ChallengeEntry", "ChallengeEntry")
                        .WithOne("ChallengeEntryImage")
                        .HasForeignKey("Spotopedia.Data.Models.ChallengeEntryImage", "ChallengeEntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.ChallengeImage", b =>
                {
                    ...
                    b.HasOne("Spotopedia.Data.Models.Challenge", "Challenge")
                        .WithOne("Image")
                        .HasForeignKey("Spotopedia.Data.Models.ChallengeImage", "ChallengeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.PostComment", b =>
                {
                    ...
                    b.HasOne("Spotopedia.Data.Models.PostComment", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.SpotReport", b =>
                {
                    ...
                    b.HasOne("Spotopedia.Data.Models.Spot", "ReportedSpot")
                        .WithMany("Reports")
                        .HasForeignKey("ReportedSpotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.ChallengeEntry", b =>
                {
                    b.Navigation("ChallengeEntryImage");
                });
