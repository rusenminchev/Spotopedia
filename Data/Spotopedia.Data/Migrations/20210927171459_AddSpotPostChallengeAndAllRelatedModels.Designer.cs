...
namespace Spotopedia.Data.Migrations
{
    ...
    [Migration("20210927171459_AddSpotPostChallengeAndAllRelatedModels")]
    partial class AddSpotPostChallengeAndAllRelatedModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.SpotComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.SpotCommentVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("SpotCommentId");

                    b.ToTable("SpotCommentVotes");
                });
            ...
            modelBuilder.Entity("Spotopedia.Data.Models.SpotCommentVote", b =>
                {
                    b.HasOne("Spotopedia.Data.Models.ApplicationUser", "AddedByUser")
                        .WithMany("SpotCommentVotes")
                        .HasForeignKey("AddedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Spotopedia.Data.Models.SpotComment", "SpotComment")
                        .WithMany("SpotCommentVotes")
                        .HasForeignKey("SpotCommentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("AddedByUser");

                    b.Navigation("SpotComment");
                });
